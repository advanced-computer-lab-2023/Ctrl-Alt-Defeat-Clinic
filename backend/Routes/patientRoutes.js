...
router
  ...
  .get(authMiddlewares.protect, authMiddlewares.restrictTo('patient'), patientController.viewFamilyMembers);
...
router
  .route('/viewDoctorSlots')
  .get(authMiddlewares.protect, authMiddlewares.restrictTo('patient'), patientController.viewDoctorSlots);
router
  .route('/viewPatientAppointments')
  .get(authMiddlewares.protect, authMiddlewares.restrictTo('patient'), patientController.viewPatientAppointments);
router
...
router
  ...
  .post(authMiddlewares.protect, authMiddlewares.restrictTo('patient'), patientController.cancelHealthPackage);
router
...
router
  ...
  .post(
    ...
    authMiddlewares.restrictTo('patient'),
